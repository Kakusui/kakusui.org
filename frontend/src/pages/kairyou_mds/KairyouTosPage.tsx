...
const KairyouTermsOfServicePage: React.FC = () => {
    return (
        <Box p={4}>
            ...
            <Text mb={4}>
                Kakusui does not possess the trademark or any other intellectual property rights on Kairyou, its name, or logo. You are free to use the project within the bounds of the LGPLv2.1 or GPLv3 licenses as applicable.
            </Text>
